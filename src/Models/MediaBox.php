...
class MediaBox extends Model
{
     ...
     * @return Media メディア
     */
    public function upload(mixed $data, string $filename, ?string $subdirectory = null,  ?string $content_type = null, mixed $uploaded_at = null): Media
    {
     ...
     * @return Media|null メディアまたはnull
     */
    public function find(?string $path): Media|null
    {
