...
class PostTest extends TestCase
{
     ...
     * 投稿カテゴリの設定と変更
     * 
     * - カテゴリ名を指定した場合は、カテゴリ所有プロフィールと投稿者プロフィールが一致し、かつ投稿タイプと同じカテゴリタイプのカテゴリの中からカテゴリ名が一致するカテゴリのIDが設定されることを確認します。
    ...
    public function test_set_category_name()
    {
        ...
        // 評価
        $this->assertEquals($pickupForPhoto->id, $photo->category->id, 'カテゴリ名を指定した場合は、カテゴリ所有プロフィールと投稿者プロフィールが一致し、かつ投稿タイプと同じカテゴリタイプのカテゴリの中からカテゴリ名が一致するカテゴリのIDが設定されること');
     ...
     * 投稿タグリストの設定と変更
     *
     * - タグ名の配列を指定した場合は、タグ所有プロフィールと投稿者プロフィールが一致し、かつ投稿タイプと同じタグタイプのカテゴリの中からタグ名が一致するタグのIDが設定されることを確認します。
     ...
     * 投稿レコードリストの設定と変更
     * 
     * - レコーダタイプが投稿タイプと一致する必要があることを確認します。
     * 
     * @link https://github.com/ryossi/feeldee-framework/wiki/投稿#投稿レコードリストの設定と変更
     */
     ...
     * 投稿レコードリストの設定と変更
     * 
     * - レコーダ名の配列を指定した場合は、レコーダ所有プロフィールと投稿者プロフィールが一致し、かつ投稿タイプと同じタグタイプのレコーダの中からレコーダ名が一致するレコーダが使用されることを確認します。
    ...
    public function test_set_records_name()
    {
        ...
        // レコーダ名の配列を指定した場合は、レコーダ所有プロフィールと投稿者プロフィールが一致し、かつ投稿タイプと同じタグタイプの
